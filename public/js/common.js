...
function eventHandler() {
	...
	const labels = []; //put dates here

	for (var i = 0; i < 30; i++) {
		labels[i] = "".concat(i + 1, " \u043D\u043E\u044F\u0431\u0440\u044F 2020 \u0433.");
	} //
	...
	let StatLabels = [];
	let StatDataArr = []; //put dates here

	for (var i = 0; i < 200; i++) {
		StatLabels[i] = "".concat(i + 1, " \u043D\u043E\u044F\u0431\u0440\u044F 2021 \u0433.");
	...
	StatDataArr = reduceArr(StatDataArr, 25); //--similar way(as a color here) u can give StatLabels and StatDataArr... probably, I hope so
